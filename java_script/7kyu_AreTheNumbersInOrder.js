// Are the numbers in order? In this Kata, your function receives an array of
// integers as input. Your task is to determine whether the numbers are in
// ascending order. An array is said to be in ascending order if there are no
// two adjacent integers where the left integer exceeds the right integer in
// value.
...
// tested in this Kata - feel free to raise an Issue if you see such a list
// being tested.
...
console.log(inAscOrder([1, 2, 4, 6, 7, 3, 5]));
